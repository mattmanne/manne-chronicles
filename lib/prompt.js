...
`;
  ...
  // summaries above (which are auto-generated) since this is deliberately
  // curated continuity the model has otherwise been shown to forget or
  // contradict once it's outside the last ~40 log entries of context.
...
`
  ...
  return WORLD_AND_RULES + stateBlock + authorNoteBlock + openingInstructions;
}
